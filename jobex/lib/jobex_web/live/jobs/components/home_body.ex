defmodule JobexWeb.Jobs.Components.HomeBody do
  ...
  def render(assigns) do
    ...
    <div>
    <div class="flex pb-4">
    <div class="pr-5">BODY TITLE</div>
    <div>BODY CLOCK</div>
    </div>
    <table>
    <tr class="bg-available"><td>row: available</td></tr>
    <tr class="bg-completed"><td>row: completed</td></tr>
    <tr class="bg-executing"><td>row: executing</td></tr>
    <tr class="bg-retryable"><td>row: retryable</td></tr>
    <tr class="bg-discarded"><td>row: discarded</td></tr>
    </table>
    <div class="pt-4">NAV</div>
    </div>
    """
  end
