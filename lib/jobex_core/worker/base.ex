defmodule JobexCore.Worker.Base do
  ...
  def perform(job) do
    ...
    JobexWeb.Endpoint.broadcast("job-event", "worker-start", %{})
    ...
    JobexWeb.Endpoint.broadcast("job-event", "worker-finish", %{})
    JobexWeb.Endpoint.broadcast("job-refresh", "worker-finish", %{})
