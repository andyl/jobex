defmodule JobaWeb.Router do
  ...
  scope "/", JobaWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{JobaWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", JobaWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{JobaWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", JobaWeb do
    ...
    live_session :current_user,
      on_mount: [{JobaWeb.UserAuth, :mount_current_user}] do
